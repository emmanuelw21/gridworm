...
const DropdownMenu = ({ 
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {isOpen && (
        <div className={`absolute left-0 mt-1 min-w-[200px] bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-[100] ${menuClassName}`}>
