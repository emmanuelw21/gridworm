...
import { FileX, Music, AlertTriangle, RefreshCw as RefreshCwIcon } from 'lucide-react';
...
const MediaPreview = ({ 
  ...
  const handleMediaLoad = useCallback((e) => {
    ...
    // Report natural dimensions for images and videos
  ...
  if (isAudio(media.type)) {
    return (
      ...
      >
        <LoadingIndicator />
        <Music size={32} className={`text-blue-500 mb-2 transition-opacity duration-300 ${isLoading ? 'opacity-0' : 'opacity-100'}`} />
